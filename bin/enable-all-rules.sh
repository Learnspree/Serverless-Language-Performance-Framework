...
aws events enable-rule --name coldstart-ruby25-$environment-hourly-burst 
...
aws events enable-rule --name warmstart-ruby25-$environment-minute 
...
aws events enable-rule --name warmstart-256-ruby25-$environment-minute 
...
aws events enable-rule --name warmstart-512-ruby25-$environment-minute 