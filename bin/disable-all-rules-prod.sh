if [ $# -eq 0 ]
  then
    ...
    aws events disable-rule --name warmstart-dotnet2-prod-minute
    ...
    aws events disable-rule --name coldstart-dotnet2-prod-hourly-burst
  else
    ...
    aws events disable-rule --name warmstart-dotnet2-prod-minute --profile $1 &
    ...
    aws events disable-rule --name coldstart-dotnet2-prod-hourly-burst --profile $1 &
fi